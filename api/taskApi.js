...
exports.addTask = function (data, user_id, done){
    ...
    console.log("Api data _________",value);
    ...
    db.query(query,(err)=>{
        ...
        console.log("Ajouter a la base de donnee avec succes !", value)
        done(null, true)
...
exports.updateTask = function (data, user_id, done) {
    ...
    let {id, title, body, isdone, ref} = data;
    ...
    db.query(query,(err)=>{
        if(err) throw err;
        console.log("Its work! UPDATED ...", data);
    })
...
const getTaskBy = function ({type,user_id, key} , done){
